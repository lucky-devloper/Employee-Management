...
function Login({ handlelogin }) {
    ...
    return (
        <div className='w-[300px] h-[350px] border-2 border-[#408f68] rounded-md mt-28'>
            <form onSubmit={handleSubmit} className='w-[100%] h-[100%] flex flex-col items-center justify-center gap-3'>
                ...
                <div className='w-[100%] flex flex-col items-center text-[12px]'>
                    <p>As a Admin</p>
                ...
                <div className='w-[100%] flex flex-col items-center text-[12px]'>
                    <p>As a Employee</p>
                    <p>Username: employee1@example.com</p>
                    <p>Password: 123do</p>
                </div>
            </form>
        </div>
